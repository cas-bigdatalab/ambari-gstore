...
class GStorems(Script):
    ...
    def configure(self, env):
        ...
        for h in params.slave_hosts:
            conf_content+='{"nodeIp": "'+h+'","username": "'+params.username+'","password": "'+params.password+'","port": '+params.node_port+',"systemusername": "root","systempassword": "'+params.systempassword+'","rootpath": "'+params.gstore_dir+'/latest"}' 
        conf_content+=']}'
